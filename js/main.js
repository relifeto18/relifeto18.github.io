...
---
  ...
  $(document).ready(function () {
    ...
    adjustPosition5(false);  
    adjustPosition6(false);  
    adjustPosition7(false);  
    adjustPosition8(false);  
    adjustPosition9(false);  
  ...
  var isFlipped5 = false;
  var isFlipped6 = false;
  var isFlipped7 = false;
  var isFlipped8 = false;
  var isFlipped9 = false;
  ...
  function adjustPosition5(flipped) {
    isFlipped5 = flipped;
    var flipCard5 = document.querySelector('.flip-card-5');
    var front5 = document.querySelector('.flip-card-front-5');
    var back5 = document.querySelector('.flip-card-back-5');

    flipCard5.style.height = (isFlipped5 ? back5.offsetHeight : front5.offsetHeight) + 'px';
  }

  function adjustPosition6(flipped) {
    isFlipped6 = flipped;
    var flipCard6 = document.querySelector('.flip-card-6');
    var front6 = document.querySelector('.flip-card-front-6');
    var back6 = document.querySelector('.flip-card-back-6');

    flipCard6.style.height = (isFlipped6 ? back6.offsetHeight : front6.offsetHeight) + 'px';
  }

  function adjustPosition7(flipped) {
    isFlipped7 = flipped;
    var flipCard7 = document.querySelector('.flip-card-7');
    var front7 = document.querySelector('.flip-card-front-7');
    var back7 = document.querySelector('.flip-card-back-7');

    flipCard7.style.height = (isFlipped7 ? back7.offsetHeight : front7.offsetHeight) + 'px';
  }

  function adjustPosition8(flipped) {
    isFlipped8 = flipped;
    var flipCard8 = document.querySelector('.flip-card-8');
    var front8 = document.querySelector('.flip-card-front-8');
    var back8 = document.querySelector('.flip-card-back-8');

    flipCard8.style.height = (isFlipped8 ? back8.offsetHeight : front8.offsetHeight) + 'px';
  }

  function adjustPosition9(flipped) {
    isFlipped9 = flipped;
    var flipCard9 = document.querySelector('.flip-card-9');
    var front9 = document.querySelector('.flip-card-front-9');
    var back9 = document.querySelector('.flip-card-back-9');

    flipCard9.style.height = (isFlipped9 ? back9.offsetHeight : front9.offsetHeight) + 'px';
  }
