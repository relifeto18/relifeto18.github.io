...
<div class="container1">
  ...
  <div class="scroll-container1">
    <div class="scroll-image1">
      ...
      <img class="demo1 cursor1" src="https://i.imgur.com/tfNzEP1.jpg" style="width:20%" onclick="currentSlide1(37)" alt="Fireflies">
    </div>
  </div>
</div>
...
<div class="container2">
  ...
  <div class="mySlides2">
    <div class="numbertext">14 / 31</div>
      <img src="https://i.imgur.com/XfFcB1c.jpg" style="width:100%">
  </div>
  <div class="mySlides2">
    <div class="numbertext">15 / 31</div>
      <img src="https://i.imgur.com/9Zs2JZ5.jpg" style="width:100%">
  </div>
  <div class="mySlides2">
  ...
  <div class="scroll-container2">
    <div class="scroll-image2">
      ...
      <img class="demo2 cursor2" src="https://i.imgur.com/XfFcB1c.jpg" style="width:20%" onclick="currentSlide2(14)" alt="Castner Glacier Ice Cave">
      <img class="demo2 cursor2" src="https://i.imgur.com/9Zs2JZ5.jpg" style="width:20%" onclick="currentSlide2(15)" alt="Matanuska Glacier">
      <img class="demo2 cursor2" src="https://i.imgur.com/dQOlbkX.jpg" style="width:20%" onclick="currentSlide2(16)" alt="Frozen Tree">
      <img class="demo2 cursor2" src="https://i.imgur.com/l7APMMY.jpg" style="width:20%" onclick="currentSlide2(17)" alt="Crashed Car">
      <img class="demo2 cursor2" src="https://i.imgur.com/rZwFBZp.jpg" style="width:20%" onclick="currentSlide2(18)" alt="New York Night Scene">
      <img class="demo2 cursor2" src="https://i.imgur.com/0mta0r6.jpg" style="width:20%" onclick="currentSlide2(19)" alt="Mackinac Bridge">
      <img class="demo2 cursor2" src="https://i.imgur.com/uaGCBsT.jpg" style="width:20%" onclick="currentSlide2(20)" alt="White Cliffs">
      <img class="demo2 cursor2" src="https://i.imgur.com/hjCHHzv.jpg" style="width:20%" onclick="currentSlide2(21)" alt="White Cliffs Lighthouse">
      <img class="demo2 cursor2" src="https://i.imgur.com/LKzUdR8.jpg" style="width:20%" onclick="currentSlide2(22)" alt="Tower Bridger">
      <img class="demo2 cursor2" src="https://i.imgur.com/QxyEeOm.jpg" style="width:20%" onclick="currentSlide2(23)" alt="Bass Rock">
      <img class="demo2 cursor2" src="https://i.imgur.com/rP1kHWb.jpg" style="width:20%" onclick="currentSlide2(24)" alt="Edinburgh Castle">
      <img class="demo2 cursor2" src="https://i.imgur.com/8cNyL3z.jpg" style="width:20%" onclick="currentSlide2(25)" alt="Buddha Stupa">
      <img class="demo2 cursor2" src="https://i.imgur.com/5GOhMsl.jpg" style="width:20%" onclick="currentSlide2(26)" alt="Emerald Lake">
      <img class="demo2 cursor2" src="https://i.imgur.com/saGd94o.jpg" style="width:20%" onclick="currentSlide2(27)" alt="Emerald Lake">
      <img class="demo2 cursor2" src="https://i.imgur.com/vAA6Tgh.jpg" style="width:20%" onclick="currentSlide2(28)" alt="Double Rainbow">
      <img class="demo2 cursor2" src="https://i.imgur.com/cYciILH.jpg" style="width:20%" onclick="currentSlide2(29)" alt="Offshore Wind Turbines">
      <img class="demo2 cursor2" src="https://i.imgur.com/I69rTKG.jpg" style="width:20%" onclick="currentSlide2(30)" alt="Zhangye Danxia Landform">
      <img class="demo2 cursor2" src="https://i.imgur.com/Qv857hX.jpg" style="width:20%" onclick="currentSlide2(31)" alt="Dunhuang Yardang">
    </div>
  </div>
</div>
