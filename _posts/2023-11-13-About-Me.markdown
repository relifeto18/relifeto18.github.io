...
<table class="edu">
  <tbody>
    ...
    <tr>
      <td rowspan="2" style="padding:20px 5px 0px 0px;">
        <img src="{{ site.baseurl }}/images/Data/UNNC.png" width="65" height="65"/>
      </td>
      <td style="padding:20px 5px 0px 0px;"><strong> University of Nottingham - Ningbo, China </strong></td>
      <td style="padding:20px 5px 0px 0px;"> &emsp; September 2018 – July 2022 </td>
    </tr>
    <tr>
